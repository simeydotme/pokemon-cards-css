<script>
  ...
  <div class="card__shine {subtypes}" />
...
<style>
  ...
  .card__shine.holo:not(.v):not(.vmax):not(.vstar) {
    --space: 2px;
    --l: 50%;
    --s: 70%;
    --h: 21;
  ...
  .card__shine.v:after {
    ...
    filter: brightness(1) contrast(2.5) saturate(1);
  ...
  .card__shine.vmax {
    ...
    background-blend-mode: color-burn, screen, color-dodge;
    background-size: 80% 40%, 1100% 1100%, 600% 600%, 200% 200%;
    background-position: 
      center, 
      0% var(--posy), 
      var(--posx) var(--posy), 
      var(--posx) var(--posy);
      filter: brightness(calc((var(--hyp) + 0.6)*0.4)) contrast(2.2) saturate(.7);
